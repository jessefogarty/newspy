...
from pandas import DataFrame, read_sql_query # type: ignore
import os
import subprocess
...
go_parser = "/home/unkwn1/gitlab/nuntium/gghtml"

years = [2018]

con = sqlite3.connect("db/raw_articles.db")
articles = {}
...
for y in years:
    ...
    _mongo: MongoClient = MongoClient("172.17.0.2", 27017)  # Connect to DB
